...
<table class="table responsive table-bordered">
    <thead>
    <tr>
        <h4 class="widgettitle" style="text-align: center;">新增供應商頁面</h4>
    </tr>
    <tr>
        <th align="center">分頁碼</th>   
        <th align="center">頁面名稱</th>
        <th align="center">顯示名稱</th>
        <th align="center">新增日期</th>
        <th align="center">狀態</th>
        <th align="center">主要頁面</th>
    ...
    $sql = "SELECT * FROM page_manager ORDER BY id DESC";
    $res=mysql_query($sql);
    ...
    $sql = "SELECT * FROM page_manager ORDER BY id DESC LIMIT ".$start.",".$total;
    ...
    for($i=1;$i<=$row;$i++)
    {
        ...
        <tr align="center">
            ...
            <td width="1%" align="center"><?php echo $ary[$i]['page_name']; ?></td>
            <td width="1%" align="center"><?php echo $ary[$i]['vis_name']; ?></td>
            <td width="5%" align="center"><?php echo $ary[$i]['add_time']; ?></td>
            <td width="3%"><?php
                                switch(@$ary[$i]['status'])
                                                {
                                                    case 0:
...
<script>
    function insert_fun()
    {
        location.href='home.php?url=page';
    }

    function edit_fun(id)
    {
        location.href='home.php?url=supadd_page&id='+id;
    }
</script>